...
class InagoFlyer:
    ...
    def VolumeGet(self):
        ...
        while True:
            self.SellVolume = float(
                self.Driver.find_element_by_id("sellVolumePerMeasurementTime").text
            )

            self.BuyVolume = float(
                self.Driver.find_element_by_id("buyVolumePerMeasurementTime").text
            )
